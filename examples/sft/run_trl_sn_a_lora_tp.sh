...
#PBS -A Intel-Aurora
#PBS -o trl_fsdp_sn_lora_8b_tp.log
#PBS -e trl_fsdp_sn_lora_8b_tp.log
...
RUN_NAME="trl_fsdp_sn_lora_8b_tp"
MODEL_PATH="/home/songhappy/models/Meta-Llama-3.1-8B-Instruct/"
OUTPUT_DIR="llama-sft-lora-fsdp-tp"
...
accelerate launch --config_file="${SCRIPT_DIR}/../accelerate_configs/fsdp2_lora_tp.yaml" \
